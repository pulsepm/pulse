...
def ensure() -> None:
    ...
    for requirement in data["requirements"]["live"]:
        ...
        try:
            ...
            click.echo("No tag, commit, or branch was specified in the requirements. The default branch name will be used!")
        ...
        if not os.path.exists(package_path):
            ...
            git_download.download_package(re_package[0], re_package[1], package_path, re_package[2])
        ...
        if not os.path.exists(tmp_dir):
            ...
            for file in os.listdir(plugins_path):
                if file.endswith(f"{'.dll' if platform.system() == 'Windows' else '.so'}"):
        ...
        print(f"Package {re_package[0]}/{re_package[1]} ({re_package[2]}) has been successfully migrated!")
