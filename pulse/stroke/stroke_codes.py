...
stroke_errors = {
    ...
    31: Errors("Runtime version is not specified.", "Specify the runtime version in 'pulse.toml'.", ["Open pulse.toml if the package is initalized, otherwise run 'pulse ensure' command and then open 'pulse.toml'.", "Find the [runtime] table if it's present, otherwise declare it.", "Add version key with the string value holding the desired version of runtime."]),
