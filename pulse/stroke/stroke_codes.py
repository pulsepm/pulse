...
stroke_errors = {
    ...
    46: Errors("Release has been staged already.", "Either use 'release' command or delete the .rel file.", ["If you want to release the staged release use 'pulse release' command, otherwise delete .rel file."]),
